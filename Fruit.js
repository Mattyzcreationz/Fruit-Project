...
"Bananas have roots in Southeast Asia, spreading to Africa by 500 AD. In the 15th century, Portuguese explorers introduced them to the Americas. The fruit's convenience, sweetness, and high nutritional value quickly made it a global favorite.", "Banana"),
    ...
    new fruitResults("","Strawberries have ancient roots in Europe and North America, enjoyed by ancient Romans and Native Americans. Cultivation methods advanced in the 18th century, leading to larger, sweeter varieties. Their popularity soared due to their juicy, versatile nature, becoming a global favorite in desserts and salads.","Strawberry"),
    new fruitResults("","Raspberries have ancient roots, with evidence of their consumption dating back to prehistoric times. Widely grown in Europe, they gained popularity in the 17th century. Their delicate, sweet-tart flavor and use in culinary creations and jams make them a beloved berry globally.","Raspberry"),
    new fruitResults("","Kumquats have roots in China, historically cultivated for centuries. Introduced to Europe and the Americas in the 19th century, they're appreciated for their unique eating style—the sweet peel and tangy flesh are enjoyed together. These tiny citrus fruits gained popularity for their distinctive flavor and culinary versatility.","Kumquat"),
    new fruitResults("", "Dates have ancient origins in the Middle East, cultivated for over 6,000 years. They were crucial in the diets of ancient civilizations. Initially grown in Iraq, they spread through North Africa and Spain. High in nutrients, dates are revered for their sweetness and are a cultural staple worldwide.","Date"),
    new fruitResults("", "Mangoes have a long history, originating in South Asia over 4,000 years ago. They spread to other tropical regions via trade routes. Revered for their deliciously sweet flavor and rich, creamy texture, mangoes are celebrated globally in various cuisines, desserts, and beverages.","Mango"),
    new fruitResults("","Dragon fruit, native to Central America, was historically cultivated by the Aztecs. Later, it spread to Southeast Asia. In the 19th century, it made its way to other tropical regions. Known for its vibrant appearance and mild taste, it's prized for its antioxidants and exotic appeal.","Dragonfruit"),
    new fruitResults("", "Cranberries have a long history in North America, used by Native Americans for food and medicine. Pilgrims learned about them in the 17th century. Cultivation began in the 19th century, leading to their widespread use in sauces, juices, and various culinary delights.","Cranberry"),
    new fruitResults("","Tangerines originated in Southeast Asia and were named after Tangier, Morocco, a port from where they were shipped to Europe in the 19th century. Renowned for their easy peeling and sweet flavor, they quickly became a beloved citrus fruit globally.","Tangerine"),
    new fruitResults("","Cherries have ancient origins in Asia Minor and were enjoyed by the Greeks and Romans. They spread through Europe, and colonists introduced them to North America in the 17th century. Prized for their sweetness, cherries are celebrated in cuisines worldwide and are a symbol of summer.","Cherry"),
    new fruitResults("", "The term `'berry'` is botanical and encompasses various small, pulpy fruits, including strawberries, raspberries, and blackberries. They've been consumed for centuries worldwide, prized for their sweetness, versatility, and health benefits, often used in desserts, jams, and as fresh snacks.","Berry"),
    new fruitResults("", " Indigenous to Europe, blackberries have a long history of medicinal use, dating back to ancient Greece. They were highly valued for their health benefits and rich flavor. Cultivation expanded in the 19th century, contributing to their widespread popularity today.","BlackBerry"),
    ...
    new fruitResults("", "Historically used in Europe for medicinal purposes, bilberries were known for their potential benefits to eye health. They gained popularity in traditional medicine and folklore for their purported vision-enhancing properties.", "Bilberry"),
    new fruitResults("", "Originating from South Asia, mangoes have a rich cultural significance. They were celebrated in ancient Indian texts and have become a global favorite for their tropical, sweet taste and versatility in culinary applications.", "Mango"),
    new fruitResults("", "Tracing back to ancient China, oranges symbolized prosperity and were valued for their freshness. Their cultivation spread to the Mediterranean, where they became emblematic of health and abundance.", "Orange"),
    new fruitResults("", "Native to China, peaches were associated with longevity and luck. They were revered for their delicate flavor and became a symbol of immortality and beauty in East Asian cultures.", "Peach"),
    new fruitResults("", "Cultivated for millennia, pears symbolized immortality and beauty in East Asian cultures. Their cultivation methods evolved over time, resulting in various delicious and versatile pear varieties.", "Pear"),
